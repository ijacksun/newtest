    ...
    <Card className="w-full max-w-md mx-4 relative z-10 bg-white shadow-2xl border-0">
      <CardHeader className="text-center pb-6 pt-8">
        <div className="flex items-center justify-center space-x-2 mb-2">
          ...
          <h1 className="text-2xl font-semibold text-gray-900">stride</h1>
        </div>
        <p className="text-sm text-gray-500">By Froot</p>
      </CardHeader>
      ...
      <CardContent className="space-y-6 px-8 pb-8">
        ...
        <Button 
          variant="outline" 
          className="w-full h-12 bg-white border-gray-300 hover:bg-gray-50 text-gray-700"
        >
