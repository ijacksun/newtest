...
/* Hide scrollbar for horizontal folder scroll */
.scrollbar-hide {
...
/* Custom scrollbar for dictionary */
.dictionary-scroll {
...
/* Custom scrollbar for folders modal */
.folders-scroll {
  scrollbar-width: thin;
...
.todos-scroll::-webkit-scrollbar-thumb:hover {
  background: #4b5563;
}

/* Custom scrollbar for recent notes */
.recent-notes-scroll {
  scrollbar-width: thin;
  scrollbar-color: #9ca3af #f3f4f6;
}
